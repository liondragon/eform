...
$message = class_exists( 'Success' ) ? Success::get_result_message( 'email_failure', $context ) : 'We couldn\'t send your request right now. Please try again in a few minutes.';

if ( function_exists( 'get_header' ) ) {
    get_header();
}
?>
<main class="eforms-result-page eforms-result-page-email-failure" data-eforms-result="email_failure">
