...
- Managed staged-photo queue, additive selection/drop, three-request concurrency, and Processing transition
- Stable-ID retry, response-loss reconciliation, removal/Clear all, terminal and finalizing races
