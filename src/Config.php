...
class Config
{
    ...
    private static function admin_schema_cached()
    {
        ...
        $schema = array(
            ...
            'email.from_address' => array('type' => 'string'),
            'email.html' => array('type' => 'bool'),
            'email.reply_to_mode' => array('type' => 'enum'),
            'email.reply_to_address' => array('type' => 'string'),
            'email.reply_to_field' => array('type' => 'string'),
